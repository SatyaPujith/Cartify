    ...
    <div className="bg-gradient-to-br from-gray-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="block lg:hidden space-y-6">
          {/* Main Hero - Mobile */}
          <div className="h-80 bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-2xl overflow-hidden relative">
        ...
        <div className="hidden lg:block">
          <div className="grid grid-cols-12 gap-6 h-[500px]">
            ...
            <div className="col-span-6 bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-2xl overflow-hidden relative">
              <div className="absolute inset-0">
                <img 
              ...
              <div className="relative z-10 p-12 h-full flex flex-col justify-center">
                <div className="text-white max-w-lg">
                  ...
                  <div className="mt-8 bg-indigo-500 bg-opacity-50 backdrop-blur-sm rounded-xl p-4 inline-flex items-center border border-indigo-400">
                    <div className="text-white mr-3 text-xl">🤖</div>
                    <span className="font-semibold text-white">AI-Powered Recommendations</span>
                  </div>
                </div>
              </div>
            </div>
